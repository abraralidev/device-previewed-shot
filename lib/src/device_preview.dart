...
class DevicePreviewShot extends StatefulWidget {
  /// Create a new [DevicePreviewShot].
  const DevicePreviewShot({
    super.key,
...
class DevicePreviewWidgetState extends State<DevicePreviewShot> {
  ...
  @override
  void didUpdateWidget(covariant DevicePreviewShot oldWidget) {
          ...
          child: DeviceFrame(
            ...
            screen: VirtualKeyboard(
              ...
              child: Theme(
                ...
                child: MediaQuery(
                  data: DevicePreviewShot._mediaQuery(context),
                  child: Builder(
                    key: _appKey,
                    builder: (context) {
